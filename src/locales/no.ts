...
'contact.info.certificationsValue': 'Innehaver nødvendige sertifikat og attester for arbeid på sjøen og på rig',
  ...
  'demos.crane.desc': 'Dekkran-simulering med anti-sving kommandofiltrering, automatiserte løftesekvenser, overvåking av sikkerhetsgrenser og live alarmer.',
  'demos.crane.tags': 'Anti-sving|Sekvensering|Sikkerhetsgrenser',
